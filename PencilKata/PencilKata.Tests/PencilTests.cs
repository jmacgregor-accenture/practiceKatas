...
namespace PencilKata.Tests
{
    public class PencilTests
    {
        ...
        [Fact]
        public void ErasersHaveDegradationTooAndErasingWorksFromEndOfWord()
        {
            SetupDesk(100, 100, 2);
            var testString = "test text test";
        ...
        [Fact]
        public void WhenEditingTheStringIfNewWordExceedsErasedWordLengthOverwriteCharactersWithAtSign()
        {
            SetupDesk(100, 100, 100);
            var testString = "An apple a day keeps the doctor away!";
            var expected = "An pineap@l@ay keeps the doctor away!";

            _pencil.Write(testString);
            _pencil.Erase("apple");
            _pencil.Edit("pineapple");
